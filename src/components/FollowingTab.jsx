...
function LinkWithTwitch() {
  const twitchOauth = `https://id.twitch.tv/oauth2/authorize?response_type=token&client_id=${_envs.CLIENT_ID}&redirect_uri=http://localhost:8080/popup.html&scope=channel%3Amanage%3Apolls+channel%3Aread%3Apolls&state=c3ab8aa609ea11e793ae92361f002671`;
  return (
    <button
